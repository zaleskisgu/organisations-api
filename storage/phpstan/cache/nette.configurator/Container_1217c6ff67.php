...
class Container_1217c6ff67 extends _PHPStan_f9a2208af\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0349(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_1217c6ff67 $container)
			{
	...
	public function createServiceContainer(): Container_1217c6ff67
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'ignoreErrors' => ['#Call to an undefined method Illuminate\\\Database\\\Eloquent\\\Builder::#'],
