...
class Container_a42bc038e4 extends _PHPStan_f9a2208af\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0349(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_a42bc038e4 $container)
			{
	...
	public function createServiceContainer(): Container_a42bc038e4
	{
		return $this;
	}
