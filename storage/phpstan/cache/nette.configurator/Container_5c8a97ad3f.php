...
class Container_5c8a97ad3f extends _PHPStan_f9a2208af\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0349(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_5c8a97ad3f $container)
			{
	...
	public function createServiceContainer(): Container_5c8a97ad3f
	{
		return $this;
	}
