...
class Container_e87a5d2d1b extends _PHPStan_f9a2208af\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0349(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_e87a5d2d1b $container)
			{
	...
	public function createServiceContainer(): Container_e87a5d2d1b
	{
		return $this;
	}
