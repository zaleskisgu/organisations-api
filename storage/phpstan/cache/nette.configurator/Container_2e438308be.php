...
class Container_2e438308be extends _PHPStan_f9a2208af\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0349(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_2e438308be $container)
			{
	...
	public function createServiceContainer(): Container_2e438308be
	{
		return $this;
	}
